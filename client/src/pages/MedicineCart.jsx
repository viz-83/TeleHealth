...
const MedicineCart = () => {
    ...
    if (cart.length === 0) {
        return (
            <div className="min-h-screen bg-background-light flex flex-col items-center justify-center p-4">
                <div className="bg-white dark:bg-surface p-8 rounded-2xl shadow-sm text-center max-w-md w-full border border-gray-100 dark:border-gray-700">
                    <div className="bg-teal-50 dark:bg-teal-900/30 w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6">
                        <ShoppingBag className="h-10 w-10 text-teal-600 dark:text-teal-400" />
                    </div>
                    <h2 className="text-2xl font-bold text-text-primary mb-2">Your cart is empty</h2>
                    <p className="text-text-secondary mb-8">Looks like you haven't added any medicines yet.</p>
                    <button
    ...
    return (
        <div className="min-h-screen bg-background-light p-4 pb-20 pt-8">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-4">
                        ...
                        {cart.map((item) => (
                            <div key={item._id} className="bg-white dark:bg-surface p-4 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 flex gap-4">
                                <img src={item.image} alt={item.name} className="w-20 h-20 object-cover rounded-lg bg-gray-100 dark:bg-gray-800" />

                                <div className="flex-grow">
                                    <div className="flex justify-between items-start">
                                        <div>
                                            <h3 className="font-bold text-text-primary">{item.name}</h3>
                                            <p className="text-sm text-text-secondary">{item.brand} • {item.strength}</p>
                                        </div>
                    ...
                    <div className="space-y-6">
                        <div className="bg-white dark:bg-surface p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 sticky top-4">
                            ...
                            <div className="space-y-3 mb-6">
                                <input
                                    ...
                                    className="w-full p-2 border border-gray-200 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-teal-500 outline-none text-sm bg-transparent text-text-primary"
